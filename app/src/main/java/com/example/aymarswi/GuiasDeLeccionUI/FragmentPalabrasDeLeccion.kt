package com.example.aymarswi.GuiasDeLeccionUI
...
class FragmentPalabrasDeLeccion : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnIrALeccion.setOnClickListener {
            /*Utils().pasarDeFragment(requireActivity() as AppCompatActivity, R.id.contenedorDeFragments,
                FragmentDinamica1()
            )*/
        }
    ...
    private inner class LeccionesPagerAdapter(fragmentManager: FragmentManager) :
        ...
        private val NUM_PAGES = 9 // Número total de páginas
