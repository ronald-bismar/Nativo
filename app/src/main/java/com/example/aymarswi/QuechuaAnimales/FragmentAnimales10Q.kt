...
class FragmentAnimales10Q : Fragment() {
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_animales10_q, container, false)
        ...
        Utils().sopaDeLetras(
            ...
            rootView,palabra1,
            palabra2,palabra3,
            palabra4, btnContinuar, 'u', requireActivity() as
                    AppCompatActivity, R.id.fragmentContainerView3, FragmentAnimales10Q(), args)
        return rootView  }
}