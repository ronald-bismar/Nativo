...
class FragmentNumeros2 : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val rootView: View = inflater.inflate(R.layout.fragment_numeros2, container, false)
        ...
        Utils().deslizar3PalabrasA3Contenedores(
            ...
            txtCKimsaqallqu,
            txtKimsa.text.toString(), txtPhisqa.text.toString(), txtKimsaqallqu.text.toString(),R.id.contenedorDeFragments,
            FragmentNumeros3(),
            args, puntaje
        )
